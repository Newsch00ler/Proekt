...
headers = ['№', 'Вид публикации', 'Гриф/без грифа', 'Наименование', 'Авторы (ФИО полностью)', 'Институт (факультет)', 'Кол-во печатных листов', 'Издатель', 'Год издания']
...
for work in worksDB:
    ...
    data.append((i, type, stamp, name_work, autor, 'Институт', pages_number, publisher, publishing_year))
    i = i + 1
