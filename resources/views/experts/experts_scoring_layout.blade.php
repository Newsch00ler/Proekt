...
@section('experts_main_content')
    <div class="container" style="flex-direction: column;">
        ...
        <h2 style="margin-bottom: 2%;"><a href="#" style="color: #ffffff">Сетевые игровые технологии как средство повышения эффективности учебного процесса</a></h2>
        <h2 style="margin-bottom: 2%;">Процент оригинальности работы <a href="#" style="color: #ffffff">...%</a></h2>
